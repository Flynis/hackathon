...
{
    private Mock<HackathonEvent> _hackathonMock = new Mock<HackathonEvent>();
    ...
    public void TestCorrectHarmonyResult()
    {
        ...
        _hackathonMock.Setup(h => h.HoldEvent(new List<Developer>(), new List<Developer>())).Returns(wishlists);
